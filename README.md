...
Gemma 3 4B 在全部語料中共識別出 **33,931 個**地名 entity，經後處理規則與人工審查清洗後，最終建立包含 **1,626 個景點**的清單，用於後續 PMI 共現網絡建構。
...
PMI 值越高代表兩景點越常被一起提及，超越偶然期望的程度越大。篩選 cooccur ≥ 3 且 PMI > 0 的有效邊，構成包含 **869 個節點**、**2,141 條邊**、平均 PMI = 3.601 的共現網絡。1,626 個景點中，有 **869 個**進入共現網絡；其餘 **757 個景點**未與任何景點形成穩定共現，從未出現於他人行程的同篇文章中。
...
| PTT 文章總數 | 20,487 篇 |
| 有效遊記 | 5,409 篇 |
| NER entity（Gemma 原始產出）| 33,931 個 |
| 清洗後景點清單 | 1,626 個 |
| PMI 網絡節點 | 869 個 |
| 未進入網絡的景點 | 757 個 |
| PMI 網絡邊 | 2,141 條 |
